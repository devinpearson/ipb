...
export class CardApi implements ICardApi {
  ...
  async uploadEnv(_cardKey: number, _env: object): Promise<EnvResponse> {
    const response = {
      data: {
        result: {
          variables: {
  ...
  async uploadCode(_cardKey: number, _code: object): Promise<CodeResponse> {
    const response = {
      data: {
        result: {
  ...
  async getEnv(_cardKey: number): Promise<EnvResponse> {
    const response = {
      data: {
        result: {
          variables: {
  ...
  async getCode(_cardKey: number): Promise<CodeResponse> {
    const response = {
      data: {
        result: {
          codeId: 'EA729EB9-79B4-4AF9-AE6A-B9BE4702C111',
  ...
  async getPublishedCode(_cardKey: number): Promise<CodeResponse> {
    const response = {
      data: {
        result: {
          codeId: 'EA729EB9-79B4-4AF9-AE6A-B9BE4702C111',
  ...
  async toggleCode(_cardKey: number, enabled: boolean): Promise<CodeToggle> {
    const response = {
      data: {
        result: {
          Enabled: enabled,
  ...
  async getExecutions(_cardKey: number): Promise<ExecutionResult> {
    const response = {
      data: {
        result: {
          executionItems: [
